...
{
	firingdelay = max_fire_delay; //  Setting firing delay -- TODO change to an alarm
	recoil = 4;
	ScreenShake(2, 10);
	...
	with (instance_create_layer(x, y, "Bullets", obj)) // Create the obj and provide its ID to with
	{
